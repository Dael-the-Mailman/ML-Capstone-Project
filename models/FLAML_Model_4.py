...
if __name__ == "__main__":
    ...
    with open("{automl.best_estimator}_classification_fe.json", "w") as fp:
    ...
    print('Best accuracy on validation data: {0:.4g}'.format(1-automl.best_loss))
    print('Training duration of best run: {0:.4g} s'.format(automl.best_config_train_time))
    with open("{automl.best_estimator}_regression_fe.json", "w") as fp:
        model = {automl.best_estimator : automl.best_config}
        json.dump(model, fp)
    ...
    print('Best accuracy on validation data: {0:.4g}'.format(1-automl.best_loss))
    print('Training duration of best run: {0:.4g} s'.format(automl.best_config_train_time))
    with open("{automl.best_estimator}_classification_fe_plus.json", "w") as fp:
        model = {automl.best_estimator : automl.best_config}
        json.dump(model, fp)
    ...
    print('Best accuracy on validation data: {0:.4g}'.format(1-automl.best_loss))
    print('Training duration of best run: {0:.4g} s'.format(automl.best_config_train_time))
    with open("{automl.best_estimator}_regression_fe_plus.json", "w") as fp:
        model = {automl.best_estimator : automl.best_config}
        json.dump(model, fp)
